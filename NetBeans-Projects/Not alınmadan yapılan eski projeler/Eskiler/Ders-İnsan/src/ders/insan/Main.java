...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Bil öğrenci3 = new SosyalÖğr("Adım",10); olmaz, sosyal abstract
        Bil öğrenci3 = new MatÖğr("Sad",666); // İnterface tipinde değişken tanımlanabilir.
        // Sadece Bil'e bağlı alt classların tipinde atama yapabiliriz.
        ((MatÖğr)öğrenci3).adYazdır(); // Bil tipinde olduğu için , casting olmak zorunda
        ...
        ((MatÖğr)öğrenci1).bilgisayardaYaz(); // Öğr'içinde olmadığı için casting yapmak zorundayız.
